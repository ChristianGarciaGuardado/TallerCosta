...
def presupuesto_pdf(id):
    """Genera y descarga el PDF del presupuesto usando el diseño original de Taller Costa"""
    p = Presupuesto.query.get_or_404(id)
    buffer = io.BytesIO()
    ...
    # Lo dejamos como as_attachment=False para que se visualice directo en el navegador de manera prolija
